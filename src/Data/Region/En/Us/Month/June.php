...
class June extends Month {
    public static $recurringEvents = [
        "1" => ["Buddah Birthday", "Global Day of Parents", "Heimlich Maneuver Day", "National Go Barefoot Day", "National Olive Day", "Oscar The Grouch Day", "Say Something Nice Day", "Stand For Children Day"],
        "2" => ["National Bubba Day", "National Rotisserie Chicken Day"],
        "3" => ["National Egg Day", "Chimborazo Day", "Mike The Headless Chicken Day", "Positive Power of Humor and Creativity Days"],
        ...
        "5" => ["Positive Power of Humor and Creativity Days", "Festival of Popular Delusions Day", "Hot Air Balloon Day", "National Moonshine Day", "World Environment Day", "Apple I I Day"],
        "6" => ["D Day", "Drive-in Movie Day", "National Higher Education Day", "Russian Language Day", "Yo Yo Day"],
        "7" => ["Boone Day", "VCR Day"],
        "8" => ["National Caribbean American HIV/AIDS Awareness Day", "Upsy Daisy Day", "World Oceans Day"],
        "9" => ["Donald Duck Day", "International Archives Day", "Toy Industry Day", "World APS Day"],
        "10" => ["Alcoholics Anonymous Day", "Ball Point Pen Day", "Iced Tea Day"],
        "11" => ["Corn on the Cob Day", "National Cotton Candy Day", "National Making Life Beautiful Day"],
        "12" => ["Crowded Nest Awareness Day", "Loving Day", "National Jerky Day", "National Peanut Butter Cookie Day", "Superman Day", "World Day Against Child Labor"],
        "13" => ["Brain Injury Awareness Day", "International Albinism Awareness Day", "Random Acts of Light", "Roller Coaster Day"],
        "14" => ["Family History Day", "International Bath Day", "National Bourbon Day", "Pause for the Pledge Day", "World Blood Donor Day", "National Nursing Assistants Day"],
        ...
        "17" => ["Eat Your Vegetables Day", "National Garbage Man Day", "World Day To Combat Desertification and Drought", "World Tesselation Day"],
        ...
        "21" => ["World Giraffe Day", "World Handshake Day", "World Humanist Day", "World Hydrography Day", "World Music Day"],
        "22" => ["Baby Boomer's Recognition Day", "HVAC Technicians Day", "Global Smurfs Day"],
        "23" => ["Stupid Guy Thing Day", "World Rainforest Day", "Worldwide VW Beetle Day", "International Widows' Day", "Let It Go Day", "National Hydration Day", "Pink Flamingo Day", "Public Service Day", "Runner's Selfie Day", "SAT Math Day", "Typing Day"],
        "24" => ["Celebration of the Senses", "International Fairy Day", "Stonewall National Monument Day", "World UFO Day"],
        "25" => ["Color TV Day", "Day of The Seafarer", "Global Beatles Day", "National Catfish Day"],
        "26" => ["Harry Potter Day", "International Day Against Drug Abuse and Illicit Trafficking", "International Day in Support of Victims of Torture", "National Canoe Day"],
