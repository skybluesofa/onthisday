...
class September extends Month {
    public static $recurringEvents = [
        ...
        "8" => ["Bullet Journal Day", "International Cat Day", "The Date to Create", "Happiness Happens Day", "Odie Day", "Sneak Some Zucchini Onto Your Neighbor's Porch Night", "Wear Your Mother's Jewelry Day"],
        ...
        "11" => ["Ingersoll Day", "Presidential Joke Day"],
        "12" => ["IBM PC Day", "International Youth Day", "Milkman Day", "Sewing Machine Day", "Vinyl Record Day"],
        "13" => ["International Lefthander's Day"],
        "14" => ["International Rose' Day", "National Navajo Code Talkers Day", "Spirit of '45 Day", "V-J Day"],
        "15" => ["Best Friends Day", "Chauvin Day", "Check The Chip Day", "National Relaxation Day", "National No SpongeBob Day"],
        "16" => ["Joe Miller's Joke Day", "National Airborne Day", "National Rollercoaster Day", "Wave at Surveilance Day"],
        "17" => ["Black Cat Appreciation Day", "I Love My Feet Day", "Meaning of 'Is' Day", "National Nonprofit Day", "National Thrift Shop Day"],
        "18" => ["Bad Poetry Day", "Birth Control Pills Day", "Mail Order Catalog Day", "National Badge Ribbon Day", "National Fajita Day", "Serendipity Day"],
        "19" => ["Aviation Day", "'Black Cow' Root Beer Float Day", "Coco Chanel Day", "International Orangutan Day", "World Photo Day"],
        "20" => ["National Radio Day", "World Mosquito Day"],
        "21" => ["Brazilian Blow-out Day", "Internet Self-care Day", "National Spumoni Day", "Poet's Day", "Senior Citizen's Day"],
        "22" => ["Be An Angel Day", "National Bao Day", "Southern Hemisphere Hoodie Hoo Day", "Take Your Cat To The Vet Day"],
        ...
        "25" => ["Kiss and Make Up Day", "National Park Service Day", "National Second-hand Wardrobe Day"],
        "26" => ["National Dog Day", "National Toilet Paper Day", "National WebMistress Day", "Women's Equality Day"],
        "27" => ["Just Because Day", "The Duchess Who Wasn't Day"],
        "28" => ["Race Your Mouse Around the Icons Day", "Radio Commercials Day", "Crackers Over The Keyboard Day"],
        ...
        "30" => ["International Cabernet Sauvignon Day", "International Day of The Victims of Enforced Disappearances", "International Whale Shark Day", "National Grief Awareness Day", "National Holistic Pet Day", "National Toasted Marshmallow Day"],
